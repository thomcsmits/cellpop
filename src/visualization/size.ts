...
export function getDimensions(
  ...
  const dimensionsGlobal = getDimensionsGlobal(
    width,
    widthLeft,
    widhtMiddle,
    widthRight,
    widthMarginLeft,
    widthMarginMiddleLeft,
    widthMarginMiddleRight,
    widthMarginRight,
    height,
    heightTop,
    heightMiddle,
    heightBottom,
    heightMarginTop,
    heightMarginMiddleTop,
    heightMarginMiddleBottom,
    heightMarginBottom,
    heightExtension,
    heightExtensionMiddle,
    heightExtensionMarginTop,
...
export function checkDimensionsGlobal(
  dimensionsGlobal: CellPopDimensionsGlobal,
) {
  ...
  for (let i = 0; i < dimensionsGlobal.width.parts.lengths.length; i++) {
    if (!dimensionsGlobal.width.parts.lengths[i]) {
      dimensionsGlobal.width.parts.lengths[i] =
        0.25 * dimensionsGlobal.width.total;
    }
  ...
  for (let i = 0; i < dimensionsGlobal.width.margins.lengths.length; i++) {
    if (!dimensionsGlobal.width.margins.lengths[i]) {
      dimensionsGlobal.width.margins.lengths[i] =
        0.05 * dimensionsGlobal.width.total;
    }
  ...
  for (let i = 0; i < dimensionsGlobal.height.parts.lengths.length; i++) {
    if (!dimensionsGlobal.height.parts.lengths[i]) {
      dimensionsGlobal.height.parts.lengths[i] =
        0.25 * dimensionsGlobal.height.total;
    }
  ...
  for (let i = 0; i < dimensionsGlobal.height.margins.lengths.length; i++) {
    if (!dimensionsGlobal.height.margins.lengths[i]) {
      dimensionsGlobal.height.margins.lengths[i] =
        0.05 * dimensionsGlobal.height.total;
    }
    if (dimensionsGlobal.height.margins.lengths[i] < 1) {
      dimensionsGlobal.height.margins.lengths[i] *=
        dimensionsGlobal.height.total;
    }
  }

  // check if all widths combine to the total width, otherwise resize
  const widthSum = [
    ...dimensionsGlobal.width.parts.lengths,
    ...dimensionsGlobal.width.margins.lengths,
  ].reduce((a, b) => a + b, 0);
  if (
    widthSum !==
    dimensionsGlobal.width.total - 2 * dimensionsGlobal.width.border
  ) {
    const widthScale =
      (dimensionsGlobal.width.total - 2 * dimensionsGlobal.width.border) /
      widthSum;
  ...
  const heightSum = [
    ...dimensionsGlobal.height.parts.lengths,
    ...dimensionsGlobal.height.margins.lengths,
  ].reduce((a, b) => a + b, 0);
  if (
    heightSum !==
    dimensionsGlobal.height.total - 2 * dimensionsGlobal.height.border
  ) {
    const heightScale =
      (dimensionsGlobal.height.total - 2 * dimensionsGlobal.height.border) /
      heightSum;
...
function updateOffsets(dimensionsGlobal: CellPopDimensionsGlobal) {
  ...
  // width parts
  dimensionsGlobal.width.parts.offsets = [
    borderWidth + dimensionsGlobal.width.margins.lengths[0],
  ];
  ...
  // height parts
  dimensionsGlobal.height.parts.offsets = [
    borderHeight + dimensionsGlobal.height.margins.lengths[0],
  ];
 ...
 */
export function getDimensionsFromGlobal(
  dimensionsGlobal: CellPopDimensionsGlobal,
): CellPopDimensions {
  const dimensions = {
    ...
    detailBar: {
      offsetWidth: dimensionsGlobal.width.parts.offsets[1],
      offsetHeight: dimensionsGlobal.height.parts.offsets[0],
      width: dimensionsGlobal.width.parts.lengths[1],
      height: dimensionsGlobal.extension.parts.lengths[0],
      margin: {
        left: dimensionsGlobal.width.margins.lengths[1],
        right: dimensionsGlobal.width.margins.lengths[2],
        top: dimensionsGlobal.extension.margins.lengths[0],
        bottom: dimensionsGlobal.extension.margins.lengths[1],
      },
    },
...
export function updateDimensionsWithGlobal(
...
export function drawSizeBoundaries(
  data: CellPopData,
  dimensions: CellPopDimensions,
  fraction: boolean,
  ...
  const svg = d3.select("g.main").append("g").attr("class", "boundary");
  ...
  drag.on("drag", function (event) {
    switch (className) {
      ...
      case "boundary-width1": // between margin 0 and part 0
        if (
          event.x > dimensionsGlobal.width.border &&
          event.x < dimensionsGlobal.width.margins.offsets[1]
        ) {
          dimensionsGlobal.width.parts.offsets[0] = event.x;
          dimensionsGlobal.width.margins.lengths[0] =
            event.x - dimensionsGlobal.width.border;
          dimensionsGlobal.width.parts.lengths[0] =
            dimensionsGlobal.width.margins.offsets[1] - event.x;
        }
        break;
      case "boundary-width2": // between part 0 and margin 1
        if (
          event.x > dimensionsGlobal.width.parts.offsets[0] &&
          event.x < dimensionsGlobal.width.parts.offsets[1]
        ) {
          dimensionsGlobal.width.margins.offsets[1] = event.x;
          dimensionsGlobal.width.parts.lengths[0] =
            event.x - dimensionsGlobal.width.parts.offsets[0];
          dimensionsGlobal.width.margins.lengths[1] =
      ...
      case "boundary-width3": // between margin 1 and part 2
        if (
          event.x > dimensionsGlobal.width.margins.offsets[1] &&
          event.x < dimensionsGlobal.width.margins.offsets[2]
        ) {
          dimensionsGlobal.width.parts.offsets[1] = event.x;
          dimensionsGlobal.width.margins.lengths[1] =
            event.x - dimensionsGlobal.width.margins.offsets[1];
          dimensionsGlobal.width.parts.lengths[1] =
      ...
      case "boundary-width4": // between part 2 and margin 2
        if (
          event.x > dimensionsGlobal.width.parts.offsets[1] &&
          event.x < dimensionsGlobal.width.parts.offsets[2]
        ) {
          dimensionsGlobal.width.margins.offsets[2] = event.x;
          dimensionsGlobal.width.parts.lengths[1] =
            event.x - dimensionsGlobal.width.parts.offsets[1];
          dimensionsGlobal.width.margins.lengths[2] =
      ...
      case "boundary-width5": // between margin 2 and part 3
        if (
          event.x > dimensionsGlobal.width.margins.offsets[2] &&
          event.x < dimensionsGlobal.width.margins.offsets[3]
        ) {
          dimensionsGlobal.width.parts.offsets[2] = event.x;
          dimensionsGlobal.width.margins.lengths[2] =
            event.x - dimensionsGlobal.width.margins.offsets[2];
          dimensionsGlobal.width.parts.lengths[2] =
      ...
      case "boundary-width6": // between part 3 and margin 4
        if (
          event.x > dimensionsGlobal.width.parts.offsets[2] &&
          event.x < dimensionsGlobal.width.total - dimensionsGlobal.width.border
        ) {
          dimensionsGlobal.width.margins.offsets[3] = event.x;
          dimensionsGlobal.width.parts.lengths[2] =
            event.x - dimensionsGlobal.width.parts.offsets[2];
          dimensionsGlobal.width.margins.lengths[3] =
            dimensionsGlobal.width.total - event.x;
        }
        break;
      case "boundary-width7": // between margin 4 and side
        ...
        if (
          event.x >
          dimensionsGlobal.width.total - dimensionsGlobal.width.border
        ) {
          // make svg bigger
          dimensionsGlobal.width.total =
            event.x + dimensionsGlobal.width.border;
      ...
      case "boundary-height1": // between margin 0 and part 0
        if (
          event.y > dimensionsGlobal.height.border &&
          event.y < dimensionsGlobal.height.margins.offsets[1]
        ) {
          dimensionsGlobal.height.parts.offsets[0] = event.y;
          dimensionsGlobal.height.margins.lengths[0] =
            event.y - dimensionsGlobal.height.border;
          dimensionsGlobal.height.parts.lengths[0] =
            dimensionsGlobal.height.margins.offsets[1] - event.y;
        }
        break;
      case "boundary-height2": // between part 0 and margin 1
        if (
          event.y > dimensionsGlobal.height.parts.offsets[0] &&
          event.y < dimensionsGlobal.height.parts.offsets[1]
        ) {
          dimensionsGlobal.height.margins.offsets[1] = event.y;
          dimensionsGlobal.height.parts.lengths[0] =
            event.y - dimensionsGlobal.height.parts.offsets[0];
          dimensionsGlobal.height.margins.lengths[1] =
      ...
      case "boundary-height3": // between margin 1 and part 2
        if (
          event.y > dimensionsGlobal.height.margins.offsets[1] &&
          event.y < dimensionsGlobal.height.margins.offsets[2]
        ) {
          dimensionsGlobal.height.parts.offsets[1] = event.y;
          dimensionsGlobal.height.margins.lengths[1] =
            event.y - dimensionsGlobal.height.margins.offsets[1];
          dimensionsGlobal.height.parts.lengths[1] =
      ...
      case "boundary-height4": // between part 2 and margin 2
        if (
          event.y > dimensionsGlobal.height.parts.offsets[1] &&
          event.y < dimensionsGlobal.height.parts.offsets[2]
        ) {
          dimensionsGlobal.height.margins.offsets[2] = event.y;
          dimensionsGlobal.height.parts.lengths[1] =
            event.y - dimensionsGlobal.height.parts.offsets[1];
          dimensionsGlobal.height.margins.lengths[2] =
      ...
      case "boundary-height5": // between margin 2 and part 3
        if (
          event.y > dimensionsGlobal.height.margins.offsets[2] &&
          event.y < dimensionsGlobal.height.margins.offsets[3]
        ) {
          dimensionsGlobal.height.parts.offsets[2] = event.y;
          dimensionsGlobal.height.margins.lengths[2] =
            event.y - dimensionsGlobal.height.margins.offsets[2];
          dimensionsGlobal.height.parts.lengths[2] =
      ...
      case "boundary-height6": // between part 3 and margin 4
        if (
          event.y > dimensionsGlobal.height.parts.offsets[2] &&
          event.y <
            dimensionsGlobal.height.total - dimensionsGlobal.height.border
        ) {
          dimensionsGlobal.height.margins.offsets[3] = event.y;
          dimensionsGlobal.height.parts.lengths[2] =
            event.y - dimensionsGlobal.height.parts.offsets[2];
          dimensionsGlobal.height.margins.lengths[3] =
            dimensionsGlobal.height.total - event.y;
        }
        break;
    ...
    d3.selectAll("svg")
      .attr("width", dimensionsGlobal.width.total)
      .attr("height", dimensionsGlobal.height.total);
...
function getGridLines(dimensionsGlobal: CellPopDimensionsGlobal) {
  ...
  const lines = [
    [
      ...
      {
        x: 0,
        y: dimensionsGlobal.height.border,
        width: dimensionsGlobal.width.border,
        height: dimensionsGlobal.height.total,
        color: colorSide,
      },
    ],
    [
      "width1",
      {
        x: -lineSizeHalf + dimensionsGlobal.width.parts.offsets[0],
        y: dimensionsGlobal.height.border,
        width: lineSize,
        height: lineHeight,
        color: colorLine,
    ...
    [
      "width2",
      {
        x: -lineSizeHalf + dimensionsGlobal.width.margins.offsets[1],
        y: dimensionsGlobal.height.border,
        width: lineSize,
        height: lineHeight,
        color: colorLine,
    ...
    [
      "width3",
      {
        x: -lineSizeHalf + dimensionsGlobal.width.parts.offsets[1],
        y: dimensionsGlobal.height.border,
        width: lineSize,
        height: lineHeight,
        color: colorLine,
    ...
    [
      "width4",
      {
        x: -lineSizeHalf + dimensionsGlobal.width.margins.offsets[2],
        y: dimensionsGlobal.height.border,
        width: lineSize,
        height: lineHeight,
        color: colorLine,
    ...
    [
      "width5",
      {
        x: -lineSizeHalf + dimensionsGlobal.width.parts.offsets[2],
        y: dimensionsGlobal.height.border,
        width: lineSize,
        height: lineHeight,
        color: colorLine,
    ...
    [
      "width6",
      {
        x: -lineSizeHalf + dimensionsGlobal.width.margins.offsets[3],
        y: dimensionsGlobal.height.border,
        width: lineSize,
        height: lineHeight,
        color: colorLine,
    ...
    [
      "width7",
      {
        x: dimensionsGlobal.width.total - dimensionsGlobal.width.border,
        y: dimensionsGlobal.height.border,
        width: dimensionsGlobal.width.border,
        height: dimensionsGlobal.height.total,
        color: colorSide,
    ...
    [
      "height0",
      {
        x: dimensionsGlobal.width.border,
        y: 0,
        width: dimensionsGlobal.width.total,
        height: dimensionsGlobal.height.border,
        color: colorSide,
      },
    ],
    [
      ...
      {
        x: dimensionsGlobal.width.border,
        y: -lineSizeHalf + dimensionsGlobal.height.parts.offsets[0],
        width: lineWidth,
        height: lineSize,
        color: colorLine,
      },
    ...
    [
      ...
      {
        x: dimensionsGlobal.width.border,
        y: -lineSizeHalf + dimensionsGlobal.height.margins.offsets[1],
        width: lineWidth,
        height: lineSize,
        color: colorLine,
      },
    ...
    [
      ...
      {
        x: dimensionsGlobal.width.border,
        y: -lineSizeHalf + dimensionsGlobal.height.parts.offsets[1],
        width: lineWidth,
        height: lineSize,
        color: colorLine,
      },
    ...
    [
      ...
      {
        x: dimensionsGlobal.width.border,
        y: -lineSizeHalf + dimensionsGlobal.height.margins.offsets[2],
        width: lineWidth,
        height: lineSize,
        color: colorLine,
      },
    ...
    [
      ...
      {
        x: dimensionsGlobal.width.border,
        y: -lineSizeHalf + dimensionsGlobal.height.parts.offsets[2],
        width: lineWidth,
        height: lineSize,
        color: colorLine,
      },
    ...
    [
      ...
      {
        x: dimensionsGlobal.width.border,
        y: -lineSizeHalf + dimensionsGlobal.height.margins.offsets[3],
        width: lineWidth,
        height: lineSize,
        color: colorLine,
      },
    ...
    [
      ...
      {
        x: dimensionsGlobal.width.border,
        y: dimensionsGlobal.height.total - dimensionsGlobal.height.border,
        width: dimensionsGlobal.width.total,
        height: dimensionsGlobal.height.border,
        color: colorSide,
      },
...
function resizeLabels(dimensions: CellPopDimensions) {
  ...
  const texts = [
    [
      dimensions.textSize.ind.tickY,
      "tickY",
      0,
      (2 / 3) * dimensions.heatmap.margin.right,
    ],
    [
      dimensions.textSize.ind.labelY,
      "labelY",
      0,
      (1 / 3) * dimensions.heatmap.margin.right,
    ],
    [
      dimensions.textSize.ind.tickX,
      "tickX",
      45,
      (2 / 3) * dimensions.heatmap.margin.bottom,
    ],
    [
      dimensions.textSize.ind.labelX,
      "labelX",
      0,
      (1 / 3) * dimensions.heatmap.margin.bottom,
    ],
  ...
  for (const text of texts) {
    ...
    const textElementMaxWidth = d3.max(textElement.nodes(), (n) =>
      (n as SVGTextElement).getComputedTextLength(),
    );
    // if (text[2] !== 0) {
    //     if (text[2] !== 45) {
    ...
    if (
      textElementMaxWidth > sizePossible + 5 ||
      textElementMaxWidth < sizePossible - 5
    ) {
